...
const IconMV = memo((props) => {
    const { width = 16, height = 16 } = props
    return (
        <svg t="1720078070382" className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="10405" width={width} height={height}>
