...
const IconStepbackward = memo((props) => {
    const { width = 12, height = 12 } = props
    return (
        <svg t="1720075382542" className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="24752" width={width} height={height}>
